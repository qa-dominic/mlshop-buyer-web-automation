...
public class Home extends BaseTest {
    ...
    @Test(priority = 35, description = "To Validate Brand Filter function \"All brands\" will display all types of brand")
    public  void filterAllBrands() throws Exception{
        homeSteps.filterAllBrands();
    }
    @Test(priority = 36, description = "To Validate Brand Filter function \"Rolex\" will display rolex watch")
    public  void filterRolex() throws Exception{
        homeSteps.filterRolex();
    }
    @Test(priority = 37, description = "To Validate Brand Filter function \"Omega\" will display rolex watch")
    public  void filterOmega() throws Exception{
        homeSteps.filterOmega();
    }
    @Test(priority = 38, description = "To Validate Brand Filter function \"Tag Heuer\" will display rolex watch")
    public  void filterTagHeuer() throws Exception{
        homeSteps.filterTagHeuer();
    }
    @Test(priority = 39, description = "To Validate Brand Filter function \"Seiko\" will display rolex watch")
    public  void filterSeiko() throws Exception{
        homeSteps.filterSeiko();
    }
    @Test(priority = 40, description = "To Validate Brand Filter function \"Casio\" will display rolex watch")
